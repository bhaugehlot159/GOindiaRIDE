...
$map = @(
    @{
        kind = "js"
        key = "SECURITY_BLOCKWISE"
        source = Join-Path $RepoRoot "feature-pack\01-security\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "backend\src\routes\securityRoutes.js"
    },
    @{
        kind = "js"
        key = "SECURITY_AUTH_ROOT_BLOCKWISE"
        source = Join-Path $RepoRoot "feature-pack\01-security\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "backend\src\routes\authRoutes.js"
    },
    @{
        kind = "html"
        key = "CUSTOMER_BLOCKWISE"
        scriptId = "future-features-customer-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\02-customer\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "pages\customer-dashboard.html"
    },
    @{
        kind = "html"
        key = "CUSTOMER_ROOT_BLOCKWISE"
        scriptId = "future-features-customer-root-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\02-customer\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "customer\index.html"
    },
    @{
        kind = "html"
        key = "DRIVER_BLOCKWISE"
        scriptId = "future-features-driver-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\03-driver\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "pages\driver-dashboard.html"
    },
    @{
        kind = "html"
        key = "DRIVER_ROOT_BLOCKWISE"
        scriptId = "future-features-driver-root-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\03-driver\disabled-feature-code-blockwise.js"
    ...
    @{
        kind = "html"
        key = "ADMIN_BLOCKWISE"
        scriptId = "future-features-admin-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\04-admin\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "pages\admin-dashboard.html"
    },
    @{
        kind = "html"
        key = "ADMIN_ROOT_BLOCKWISE"
        scriptId = "future-features-admin-root-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\04-admin\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "admin\index.html"
    },
    @{
        kind = "html"
        key = "ADDITIONAL_BLOCKWISE"
        scriptId = "future-features-additional-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\05-additional\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "pages\booking.html"
    },
    @{
        kind = "html"
        key = "ADDITIONAL_ROOT_BLOCKWISE"
        scriptId = "future-features-additional-root-blockwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\05-additional\disabled-feature-code-blockwise.js"
        target = Join-Path $RepoRoot "customer\index.html"
    }
)
...
Write-Output "Injected block-wise disabled future-feature scaffolds into live/root files."
