...
$map = @(
    @{
        kind = "js"
        key = "SECURITY_ITEMWISE"
        source = Join-Path $RepoRoot "feature-pack\01-security\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "backend\src\routes\securityRoutes.js"
    },
    @{
        kind = "js"
        key = "SECURITY_AUTH_ROOT_ITEMWISE"
        source = Join-Path $RepoRoot "feature-pack\01-security\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "backend\src\routes\authRoutes.js"
    },
    @{
        kind = "html"
        key = "CUSTOMER_ITEMWISE"
        scriptId = "future-features-customer-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\02-customer\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "pages\customer-dashboard.html"
    },
    @{
        kind = "html"
        key = "CUSTOMER_ROOT_ITEMWISE"
        scriptId = "future-features-customer-root-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\02-customer\disabled-feature-code-itemwise.js"
    ...
    @{
        kind = "html"
        key = "DRIVER_ITEMWISE"
        scriptId = "future-features-driver-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\03-driver\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "pages\driver-dashboard.html"
    },
    @{
        kind = "html"
        key = "DRIVER_ROOT_ITEMWISE"
        scriptId = "future-features-driver-root-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\03-driver\disabled-feature-code-itemwise.js"
    ...
    @{
        kind = "html"
        key = "ADMIN_ITEMWISE"
        scriptId = "future-features-admin-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\04-admin\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "pages\admin-dashboard.html"
    },
    @{
        kind = "html"
        key = "ADMIN_ROOT_ITEMWISE"
        scriptId = "future-features-admin-root-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\04-admin\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "admin\index.html"
    },
    @{
        kind = "html"
        key = "ADDITIONAL_ITEMWISE"
        scriptId = "future-features-additional-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\05-additional\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "pages\booking.html"
    },
    @{
        kind = "html"
        key = "ADDITIONAL_ROOT_ITEMWISE"
        scriptId = "future-features-additional-root-itemwise-disabled"
        source = Join-Path $RepoRoot "feature-pack\05-additional\disabled-feature-code-itemwise.js"
        target = Join-Path $RepoRoot "customer\index.html"
    }
)
...
Write-Output "Injected item-wise disabled feature scaffolds into live/root files."
