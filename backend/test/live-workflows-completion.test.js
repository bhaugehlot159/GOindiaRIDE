...
test('public no-login booking shortcut keeps admin queue, email, edit, and search signals connected', () => {
  ...
  assert.match(home, /js\/location-distance\.js\?v=20260702-live-route2/);
  assert.match(home, /js\/booking-fare-calculator\.js\?v=20260702-state-tax1/);
  assert.match(home, /shared\/chunks\/home\/scripts\/index\.js\?v=20260702-live-route2/);
  ...
  assert.match(read('shared/chunks/home/scripts/index.js'), /\/api\/fares\/route-quote/);
  assert.match(read('shared/chunks/home/scripts/index.js'), /estimator\.estimateDistanceKm\(pickup, drop\)/);
  assert.match(read('shared/chunks/home/scripts/index.js'), /calculateHomeFareEstimateAsync/);
  assert.match(read('shared/chunks/home/scripts/index.js'), /pickupState: distanceDetails\.pickupState/);
  assert.match(read('shared/chunks/home/scripts/index.js'), /dropState: distanceDetails\.dropState/);
  assert.match(read('shared/chunks/home/scripts/index.js'), /states: routeStates/);
  assert.match(read('shared/chunks/home/scripts/index.js'), /home_coordinate_lookup/);
  assert.doesNotMatch(read('shared/chunks/home/scripts/index.js'), /getHomeFareDistance\(pickup, drop, ''\)/);
...
test('admin app has unified live control center and fresh service worker coverage', () => {
  ...
  assert.match(admin, /admin-app\.js\?v=20260615-admincleanup1/);
  assert.match(admin, /admin-live-control-center\.js\?v=20260613-fraud-phase1/);
  assert.doesNotMatch(legacyAdmin, /admin-live-control-center\.js/);
  assert.match(legacyAdmin, /admin-live-management-sections\.js\?v=20260614-live-management1/);
  ...
  assert.match(sw, /goindiaride-pwa-v68-20260625-sirohi1/);
...
test('homepage customer reviews require live customer name city and rating', () => {
  ...
  assert.match(home, /index\.js\?v=20260702-live-route2/);
