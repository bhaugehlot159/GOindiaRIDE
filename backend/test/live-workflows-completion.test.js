...
test('public no-login booking shortcut keeps admin queue, email, edit, and search signals connected', () => {
  ...
  assert.match(home, /js\/location-distance\.js\?v=20260625-location-distance1/);
  assert.match(home, /js\/booking-fare-calculator\.js\?v=20260625-official-route1/);
  assert.match(home, /shared\/chunks\/home\/scripts\/index\.js\?v=20260625-official-route1/);
...
test('homepage customer reviews require live customer name city and rating', () => {
  ...
  assert.match(home, /index\.js\?v=20260625-official-route1/);
