...
const userTokenPayloadHygieneStateSchema = new mongoose.Schema({
  ...
  lastPayloadHash: { type: String, default: '', trim: true },
...
userTokenPayloadHygieneStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userTokenPayloadHygieneStateSchema.index({ status: 1, updatedAt: -1 });

module.exports = mongoose.model('UserTokenPayloadHygieneState', userTokenPayloadHygieneStateSchema);
