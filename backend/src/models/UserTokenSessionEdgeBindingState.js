...
const userTokenSessionEdgeBindingStateSchema = new mongoose.Schema({
...
userTokenSessionEdgeBindingStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userTokenSessionEdgeBindingStateSchema.index({ status: 1, updatedAt: -1 });
userTokenSessionEdgeBindingStateSchema.index({ userId: 1, status: 1, updatedAt: -1 });

module.exports = mongoose.model('UserTokenSessionEdgeBindingState', userTokenSessionEdgeBindingStateSchema);
