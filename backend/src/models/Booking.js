...
const bookingSchema = new mongoose.Schema({
  ...
  adminEmailDispatch: { type: mongoose.Schema.Types.Mixed, default: {} },
  customerEmailDispatch: { type: mongoose.Schema.Types.Mixed, default: {} },
  adminWhatsAppDispatch: { type: mongoose.Schema.Types.Mixed, default: {} },
  customerSmsDispatch: { type: mongoose.Schema.Types.Mixed, default: {} },
  referralCode: { type: String, trim: true },
  pickupLocation: { type: String, default: '', trim: true, maxlength: 180 },
  pickupCoordinates: { type: mongoose.Schema.Types.Mixed, default: null },
  pickupGoogleMapsUrl: { type: String, default: '', trim: true, maxlength: 240 },
  dropLocation: { type: String, default: '', trim: true, maxlength: 180 },
  dropoffCoordinates: { type: mongoose.Schema.Types.Mixed, default: null },
  dropoffGoogleMapsUrl: { type: String, default: '', trim: true, maxlength: 240 },
  locationPins: { type: mongoose.Schema.Types.Mixed, default: {} },
  routeStopLocations: { type: mongoose.Schema.Types.Mixed, default: [] },
