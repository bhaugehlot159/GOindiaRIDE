...
const userCriticalPathCooldownStateSchema = new mongoose.Schema({
...
userCriticalPathCooldownStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userCriticalPathCooldownStateSchema.index({ status: 1, updatedAt: -1 });

module.exports = mongoose.model('UserCriticalPathCooldownState', userCriticalPathCooldownStateSchema);
