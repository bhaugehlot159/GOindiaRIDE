...
const userTokenIdentifierHardeningStateSchema = new mongoose.Schema({
...
userTokenIdentifierHardeningStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userTokenIdentifierHardeningStateSchema.index({ status: 1, updatedAt: -1 });

module.exports = mongoose.model('UserTokenIdentifierHardeningState', userTokenIdentifierHardeningStateSchema);
