...
const userSessionContextDriftStateSchema = new mongoose.Schema({
...
userSessionContextDriftStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userSessionContextDriftStateSchema.index({ status: 1, updatedAt: -1 });

module.exports = mongoose.model('UserSessionContextDriftState', userSessionContextDriftStateSchema);
