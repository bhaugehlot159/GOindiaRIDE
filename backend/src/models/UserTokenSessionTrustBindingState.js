...
const userTokenSessionTrustBindingStateSchema = new mongoose.Schema({
...
userTokenSessionTrustBindingStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userTokenSessionTrustBindingStateSchema.index({ status: 1, updatedAt: -1 });
userTokenSessionTrustBindingStateSchema.index({ userId: 1, status: 1, updatedAt: -1 });

module.exports = mongoose.model('UserTokenSessionTrustBindingState', userTokenSessionTrustBindingStateSchema);
