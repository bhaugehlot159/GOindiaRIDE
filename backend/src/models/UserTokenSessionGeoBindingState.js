...
const userTokenSessionGeoBindingStateSchema = new mongoose.Schema({
  ...
  boundCountry: { type: String, default: '', trim: true },
  boundRegion: { type: String, default: '', trim: true },
  ...
  lastRegion: { type: String, default: '', trim: true },
...
userTokenSessionGeoBindingStateSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
userTokenSessionGeoBindingStateSchema.index({ status: 1, updatedAt: -1 });
