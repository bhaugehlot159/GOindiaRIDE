...
async function createBookingAdminReviewAlert({
  ...
  const payload = {
    ...
    metadata: {
      ...
      playSound: true,
      ring: true,
      audioCue: 'booking_alarm',
      pickup: sanitizeText(pickup, 120),
      pickupCoordinates: pickupCoordinates && typeof pickupCoordinates === 'object' ? pickupCoordinates : null,
      pickupGoogleMapsUrl: sanitizeText(pickupGoogleMapsUrl, 240),
      drop: sanitizeText(drop, 120),
      dropoffCoordinates: dropoffCoordinates && typeof dropoffCoordinates === 'object' ? dropoffCoordinates : null,
      dropoffGoogleMapsUrl: sanitizeText(dropoffGoogleMapsUrl, 240),
      locationPins: locationPins && typeof locationPins === 'object' ? locationPins : {},
      routeStopLocations: Array.isArray(routeStopLocations) ? routeStopLocations.slice(0, 8) : [],
      vehicleType: sanitizeText(vehicleType, 40),
